...
# Приложение должно иметь возможность принимать POST запросы с данными нового пользователя и сохранять их в бд.
...
if __name__ == '__main__':
    uvi_run('task_03:app', host='127.0.0.1', port=8000, reload=True)
